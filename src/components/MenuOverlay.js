export default function MenuOverlay() {
    return (
        <div className="flex flex-col space-y-2 mb-3 items-center">
            ...
            <a href="/src/pages/AboutPage" className="text-gray-800 transition-colors hover:text-gray-600">O mnie</a>
            <a href="/src/pages/BooksPage" className="text-gray-800 transition-colors hover:text-gray-600">Książki</a>
