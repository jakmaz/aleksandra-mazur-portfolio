...
export default function AboutPage () {
    return (
        <div className="flex flex-col md:flex-row items-center px-8 md:space-x-20 justify-center py-4 md:py-12 bg-white">
            <div className="md:w-1/4 flex justify-center">
                <img
                    src="/images/about-image.jpg"
                    alt="Portrait of Aleksandra Mazur"
                    className="mb-8 md:mb-0 rounded-xl"
                />
            </div>
            <div className="md:w-1/2 2xl:w-1/4 flex flex-col font-noticia">
                <h2 className="text-5xl font-noticia font-bold mb-6">About</h2>
